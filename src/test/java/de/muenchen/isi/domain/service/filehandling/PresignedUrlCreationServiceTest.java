...
class PresignedUrlCreationServiceTest {
    ...
    public void beforeEach() {
        this.presignedUrlCreationService = new PresignedUrlCreationService(this.presignedUrlRepository, 10);
    ...
    void getFile()
        ...
        assertThat(this.presignedUrlCreationService.getFile(filePathModel), is(expected));
    }
    ...
    void saveFile()
        ...
        assertThat(this.presignedUrlCreationService.saveFile(filePathModel), is(expected));
    }
    ...
    void deleteFile()
        ...
        assertThat(this.presignedUrlCreationService.deleteFile(filePathModel), is(expected));
    }
