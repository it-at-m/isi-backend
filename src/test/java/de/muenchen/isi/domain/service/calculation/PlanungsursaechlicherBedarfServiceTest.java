...
class PlanungsursaechlicherBedarfServiceTest {
    ...
    void calculatePlanungsursaechlicherBedarfForKinderkrippeRoundedAndWithMean() {
        ...
        final var expected = new ArrayList<PlanungsursaechlicherBedarfProJahrModel>();
        var planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        ...
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
    ...
    void calculatePlanungsursaechlicherBedarf() {
        ...
        var planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2000));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(528990000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(31739400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(264495, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2001));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(858030000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(51481800000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(429015, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2002));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(989990000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(59399400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(494995, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2003));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(975570000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(58534200000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(487785, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2004));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(961110000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(57666600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(480555, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2005));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(946730000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(56803800000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(473365, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2006));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(932310000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(55938600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(466155, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2007));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(917850000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(55071000000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(458925, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2008));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(903360000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(54201600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(451680, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2009));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(888980000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(53338800000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(444490, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2010));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(877530000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(52651800000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(438765, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2011));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(868040000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(52082400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(434020, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2012));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(859400000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(51564000000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(429700, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2013));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(850790000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(51047400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(425395, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2014));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(842290000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(50537400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(421145, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2015));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(833860000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(50031600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(416930, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2016));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(825460000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(49527600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(412730, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2017));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(817170000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(49030200000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(408585, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2018));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(809060000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(48543600000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(404530, 2));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2019));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(800940000000000L, 10));
        planungsursaechlicherBedarf.setAnzahlKinderZuVersorgen(BigDecimal.valueOf(48056400000000000L, 12));
        planungsursaechlicherBedarf.setAnzahlGruppen(BigDecimal.valueOf(400470, 2));
        expected.add(planungsursaechlicherBedarf);
    ...
    void setVersorgungsquoteAndGruppenstaerkeInPlanungsursaechlichenBedarf() {
        ...
        var expected = new PlanungsursaechlicherBedarfProJahrModel();
        ...
        expected = new PlanungsursaechlicherBedarfProJahrModel();
    ...
    void roundValuesAndReturnModelWithRoundedValues() {
        final var model = new PlanungsursaechlicherBedarfProJahrModel();
        model.setJahr("2000");
        ...
        final var expected = new PlanungsursaechlicherBedarfProJahrModel();
    ...
    @Test
    void add() {
        final var model1 = new PlanungsursaechlicherBedarfProJahrModel();
        model1.setJahr("2000");
        model1.setAnzahlKinderGesamt(BigDecimal.valueOf(10));
        final var model2 = new PlanungsursaechlicherBedarfProJahrModel();
        model2.setJahr("2001");
    ...
    void getSobonOrientierungswertGroupedByFoerderart() {
        final var wohneinheiten = new ArrayList<WohneinheitenProFoerderartProJahrModel>();
        var planungsursachlicheWohneinheiten = new WohneinheitenProFoerderartProJahrModel();
        planungsursachlicheWohneinheiten.setFoerderart("foerderart1");
        wohneinheiten.add(planungsursachlicheWohneinheiten);
        planungsursachlicheWohneinheiten = new WohneinheitenProFoerderartProJahrModel();
    ...
    void calculatePlanungsursaechlicheBedarfeStartAtYear20() {
        ...
        var planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2019));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(48090000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
    ...
    void calculatePlanungsursaechlicheBedarfeStartAtYear9() {
        ...
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2009));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(47400000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2010));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(46720000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2011));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(46030000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2012));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(45340000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2013));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(44660000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2014));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(43970000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2015));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(43280000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2016));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(42590000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2017));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(41910000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2018));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(41490000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2019));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(41080000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
    ...
    void calculatePlanungsursaechlicheBedarfeStartAtYear1() {
        ...
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2012));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(40670000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2013));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(40260000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2014));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(39860000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2015));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(39460000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2016));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(39060000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2017));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(38670000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2018));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(38290000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
        planungsursaechlicherBedarf = new PlanungsursaechlicherBedarfProJahrModel();
        planungsursaechlicherBedarf.setJahr(Integer.toString(2019));
        planungsursaechlicherBedarf.setAnzahlKinderGesamt(BigDecimal.valueOf(37900000000000L, 10));
        expected.add(planungsursaechlicherBedarf);
    ...
    void calculate10Year15YearAnd20YearMean() {
        final var bedarfe = new ArrayList<PlanungsursaechlicherBedarfProJahrModel>();
        var bedarf = new PlanungsursaechlicherBedarfProJahrModel();
        bedarf.setJahr("2000");
        ...
        bedarfe.add(bedarf);
        bedarf = new PlanungsursaechlicherBedarfProJahrModel();
        bedarf.setJahr("2001");
    ...
    private List<WohneinheitenProFoerderartProJahrModel> createListOfPlanungsursachlicheWohneinheiten(
        final int firstYear,
        final int size
    ) {
        final var planungsursachlicheWohneinheiten = new ArrayList<WohneinheitenProFoerderartProJahrModel>();
        for (int index = 0; index < size; index++) {
            final var planungsursachlicheWohneinheit = new WohneinheitenProFoerderartProJahrModel();
