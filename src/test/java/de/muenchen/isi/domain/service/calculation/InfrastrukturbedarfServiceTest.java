...
class InfrastrukturbedarfServiceTest {
    ...
    public void beforeEach() {
        this.infrastrukturbedarfService = new InfrastrukturbedarfService(
    ...
    @Test
    void calculateBedarfForGsNachmittagBetreuungVersorgungsquote55Sobon() throws CalculationException {
        final SobonOrientierungswertJahr sobonJahr = SobonOrientierungswertJahr.JAHR_2017;
        final LocalDate gueltigAb = LocalDate.of(1998, 1, 1);
        final var wohneinheiten = new ArrayList<WohneinheitenProFoerderartProJahrModel>();
        var wohneinheitenModel = new WohneinheitenProFoerderartProJahrModel();
        ...
        final var result = infrastrukturbedarfService.calculateBedarfForGsNachmittagBetreuung(
            wohneinheiten,
            sobonJahr,
            gueltigAb,
        ...
        bedarf.setJahr(Integer.toString(2000));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("52900.763358778610000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("29095.419847328235500"));
        bedarf.setAnzahlGruppen(new BigDecimal("2424.618320610686292"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2001));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85809.160305343550000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("47195.038167938952500"));
        bedarf.setAnzahlGruppen(new BigDecimal("3932.919847328246042"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2002));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("99000.000000000030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("54450.000000000016500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4537.500000000001375"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2003));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("97557.251908397030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("53656.488549618366500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4471.374045801530542"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2004));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("96114.503816793960000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("52862.977099236678000"));
        bedarf.setAnzahlGruppen(new BigDecimal("4405.248091603056500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2005));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("94671.755725190850000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("52069.465648854967500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4339.122137404580625"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2006));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("93229.007633587820000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("51275.954198473301000"));
        bedarf.setAnzahlGruppen(new BigDecimal("4272.996183206108417"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2007));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("91786.259541984750000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("50482.442748091612500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4206.870229007634375"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2008));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("90343.511450381750000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("49688.931297709962500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4140.744274809163542"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2009));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("88900.763358778680000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("48895.419847328274000"));
        bedarf.setAnzahlGruppen(new BigDecimal("4074.618320610689500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2010));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("87752.748091603150000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("48264.011450381732500"));
        bedarf.setAnzahlGruppen(new BigDecimal("4022.000954198477708"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2011));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("86796.900000000110000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("47738.295000000060500"));
        bedarf.setAnzahlGruppen(new BigDecimal("3978.191250000005042"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2012));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85928.931000000100000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("47260.912050000055000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3938.409337500004583"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2013));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85069.641690000030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("46788.302929500016500"));
        bedarf.setAnzahlGruppen(new BigDecimal("3899.025244125001375"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2014));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("84218.945273100060000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("46320.419900205033000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3860.034991683752750"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2015));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("83376.755820369010000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("45857.215701202955500"));
        bedarf.setAnzahlGruppen(new BigDecimal("3821.434641766912958"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2016));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("82542.988262165380000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("45398.643544190959000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3783.220295349246583"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2017));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("81717.558379543700000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("44944.657108749035000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3745.388092395752917"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2018));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("80900.382795748270000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("44495.210537661548500"));
        bedarf.setAnzahlGruppen(new BigDecimal("3707.934211471795708"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2019));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("80091.378967790760000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("44050.258432284918000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3670.854869357076500"));
        expected.add(bedarf);
    ...
    @Test
    void calculateBedarfForGsNachmittagBetreuungVersorgungsquote90Sobon() throws CalculationException {
        final SobonOrientierungswertJahr sobonJahr = SobonOrientierungswertJahr.JAHR_2017;
        final LocalDate gueltigAb = LocalDate.of(1998, 1, 1);
        final var wohneinheiten = new ArrayList<WohneinheitenProFoerderartProJahrModel>();
        var wohneinheitenModel = new WohneinheitenProFoerderartProJahrModel();
        ...
        bedarf.setJahr(Integer.toString(2000));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("52900.763358778610000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("47610.687022900749000"));
        bedarf.setAnzahlGruppen(new BigDecimal("3967.557251908395750"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2001));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85809.160305343550000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("77228.244274809195000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6435.687022900766250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2002));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("99000.000000000030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("89100.000000000027000"));
        bedarf.setAnzahlGruppen(new BigDecimal("7425.000000000002250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2003));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("97557.251908397030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("87801.526717557327000"));
        bedarf.setAnzahlGruppen(new BigDecimal("7316.793893129777250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2004));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("96114.503816793960000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("86503.053435114564000"));
        bedarf.setAnzahlGruppen(new BigDecimal("7208.587786259547000"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2005));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("94671.755725190850000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("85204.580152671765000"));
        bedarf.setAnzahlGruppen(new BigDecimal("7100.381679389313750"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2006));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("93229.007633587820000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("83906.106870229038000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6992.175572519086500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2007));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("91786.259541984750000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("82607.633587786275000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6883.969465648856250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2008));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("90343.511450381750000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("81309.160305343575000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6775.763358778631250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2009));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("88900.763358778680000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("80010.687022900812000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6667.557251908401000"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2010));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("87752.748091603150000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("78977.473282442835000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6581.456106870236250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2011));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("86796.900000000110000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("78117.210000000099000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6509.767500000008250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2012));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85928.931000000100000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("77336.037900000090000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6444.669825000007500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2013));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("85069.641690000030000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("76562.677521000027000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6380.223126750002250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2014));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("84218.945273100060000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("75797.050745790054000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6316.420895482504500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2015));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("83376.755820369010000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("75039.080238332109000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6253.256686527675750"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2016));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("82542.988262165380000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("74288.689435948842000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6190.724119662403500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2017));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("81717.558379543700000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("73545.802541589330000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6128.816878465777500"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2018));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("80900.382795748270000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("72810.344516173443000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6067.528709681120250"));
        expected.add(bedarf);
        bedarf = new InfrastrukturbedarfProJahrModel();
        bedarf.setJahr(Integer.toString(2019));
        bedarf.setAnzahlPersonenGesamt(new BigDecimal("80091.378967790760000"));
        bedarf.setAnzahlPersonenZuVersorgen(new BigDecimal("72082.241071011684000"));
        bedarf.setAnzahlGruppen(new BigDecimal("6006.853422584307000"));
        expected.add(bedarf);
    ...
    @Test
    void calculateBedarfForGrundschule() throws CalculationException {
        final SobonOrientierungswertJahr sobonJahr = SobonOrientierungswertJahr.JAHR_2017;
        final LocalDate gueltigAb = LocalDate.of(1998, 1, 1);
        final var wohneinheiten = new ArrayList<WohneinheitenProFoerderartProJahrModel>();
        var wohneinheitenModel = new WohneinheitenProFoerderartProJahrModel();
        ...
        final var result = infrastrukturbedarfService.calculateBedarfForGrundschule(
            wohneinheiten,
            sobonJahr,
            gueltigAb
        );
    ...
    void getVersorgungsquoteAndGruppenstaerkeWithBedarf() {
        ...
        versorgungsQuote.setVersorgungsquoteSobonUrsaechlich(BigDecimal.valueOf(60, 2));
        versorgungsQuote.setGruppenstaerke(10);
        result = infrastrukturbedarfService.getVersorgungsquoteAndGruppenstaerkeWithBedarf(
            bedarf,
            versorgungsQuote,
