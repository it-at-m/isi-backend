...
class WeGfDistributionBaugenehmigungsverfahrenValidatorTest {

    private final WeGfDistributionBaugenehmigungsverfahrenValidator weGfDistributionValidator =
        new WeGfDistributionBaugenehmigungsverfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.weGfDistributionValidator.isValid(new AbfragevarianteBaugenehmigungsverfahrenAngelegtDto(), null),
            is(true)
        );
        ...
        abfragevariante = new AbfragevarianteBaugenehmigungsverfahrenAngelegtDto();
        abfragevariante.setWeGesamt(150);
