...
class WohneinheitenDistributionWeiteresVerfahrenValidatorTest {

    private WohneinheitenDistributionWeiteresVerfahrenValidator wohneinheitenDistributionValidator =
        new WohneinheitenDistributionWeiteresVerfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.wohneinheitenDistributionValidator.isValid(new AbfragevarianteWeiteresVerfahrenAngelegtDto(), null),
            is(true)
        );
