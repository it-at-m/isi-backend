...
class WeGfDistributionBauleitplanverfahrenValidatorTest {

    private final WeGfDistributionBauleitplanverfahrenValidator weGfDistributionValidator =
        new WeGfDistributionBauleitplanverfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.weGfDistributionValidator.isValid(new AbfragevarianteBauleitplanverfahrenAngelegtDto(), null),
            is(true)
        );

        // --

        var abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setWeGesamt(150);

        assertThat(this.weGfDistributionValidator.isValid(abfragevariante, null), is(true));

        // --

        abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setWeGesamt(150);
        ...
        assertThat(this.weGfDistributionValidator.isValid(abfragevariante, null), is(false));

        // --

        abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setWeGesamt(149);
        ...
        baugebiet3.setGfWohnenGeplant(BigDecimal.valueOf(60));
        baugebiet3.setTechnical(false);
        baugebiet4 = new BaugebietDto();
        baugebiet4.setGfWohnenGeplant(BigDecimal.valueOf(0));
        baugebiet4.setTechnical(false);
        baugebiet5 = new BaugebietDto();
        ...
        abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setGfWohnenGesamt(BigDecimal.valueOf(149));
    ...
    void isValidTechnicalBaugebiet() {
        ...
        abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setWeGesamt(151);
        ...
        abfragevariante = new AbfragevarianteBauleitplanverfahrenAngelegtDto();
        abfragevariante.setGfWohnenGesamt(BigDecimal.valueOf(151));
