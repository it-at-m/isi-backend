...
class WohneinheitenDistributionBauleitplanverfahrenValidatorTest {

    private WohneinheitenDistributionBauleitplanverfahrenValidator wohneinheitenDistributionValidator =
        new WohneinheitenDistributionBauleitplanverfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.wohneinheitenDistributionValidator.isValid(new AbfragevarianteBauleitplanverfahrenAngelegtDto(), null),
            is(true)
        );
