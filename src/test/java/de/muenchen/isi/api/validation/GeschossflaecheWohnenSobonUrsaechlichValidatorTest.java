...
class GeschossflaecheWohnenSobonUrsaechlichValidatorTest {
    ...
    void isValidSobonRelevant() {
        final var infrastrukturabfrage = new AbfrageerstellungInfrastrukturabfrageAngelegtDto();
        ...
        final var abfragevariantePlanungsrechtParag11 = new AbfrageerstellungAbfragevarianteAngelegtDto();
        ...
        final var abfragevariantePlanungsrechtParag12 = new AbfrageerstellungAbfragevarianteAngelegtDto();
    ...
    void isValidAbfragevarianteNotSobonRelevant() {
        ...
        final var abfragevariantePlanungsrechtParag30 = new AbfrageerstellungAbfragevarianteAngelegtDto();
        ...
        final var abfragevariantePlanungsrechtParag34 = new AbfrageerstellungAbfragevarianteAngelegtDto();
