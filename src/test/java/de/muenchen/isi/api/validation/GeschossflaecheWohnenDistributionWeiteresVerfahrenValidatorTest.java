...
class GeschossflaecheWohnenDistributionWeiteresVerfahrenValidatorTest {

    private GeschossflaecheWohnenDistributionWeiteresVerfahrenValidator geschossflaecheWohnenDistributionValidator =
        new GeschossflaecheWohnenDistributionWeiteresVerfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.geschossflaecheWohnenDistributionValidator.isValid(
                    new AbfragevarianteWeiteresVerfahrenAngelegtDto(),
                    null
                ),
            is(true)
        );
