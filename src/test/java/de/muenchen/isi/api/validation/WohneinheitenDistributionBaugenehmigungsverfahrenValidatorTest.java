...
class WohneinheitenDistributionBaugenehmigungsverfahrenValidatorTest {

    private WohneinheitenDistributionBaugenehmigungsverfahrenValidator wohneinheitenDistributionValidator =
        new WohneinheitenDistributionBaugenehmigungsverfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.wohneinheitenDistributionValidator.isValid(
