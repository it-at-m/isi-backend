...
class WeGfDistributionWeiteresVerfahrenValidatorTest {

    private final WeGfDistributionWeiteresVerfahrenValidator weGfDistributionValidator =
        new WeGfDistributionWeiteresVerfahrenValidator();

    @Test
    void isValidNonTechnicalBaugebiet() {
        assertThat(
            this.weGfDistributionValidator.isValid(new AbfragevarianteWeiteresVerfahrenAngelegtDto(), null),
            is(true)
        );

        // --

        var abfragevariante = new AbfragevarianteWeiteresVerfahrenAngelegtDto();
        ...
        abfragevariante = new AbfragevarianteWeiteresVerfahrenAngelegtDto();
        abfragevariante.setWeGesamt(150);
