...
class RestExceptionHandlerTest {
    ...
    void handleOptimisticLockingException() {
        ...
        assertThat(responseDto.getTraceId(), is(nullValue()));
        assertThat(responseDto.getSpanId(), is(nullValue()));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is(nullValue()));
    ...
    void handleEntityIsReferencedException() {
        ...
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("EntityIsReferencedException"));
    }
    ...
    void handleCsvAttributeErrorException() {
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("CsvAttributeErrorException"));
    }
    ...
    void testhandleFileImportFailedException() {
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("FileImportFailedException"));
    }
    ...
    void handleMimeTypeExtractionFailedException() {
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("MimeTypeExtractionFailedException"));
    }
    ...
    void handleKoordinatenException() {
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("KoordinatenException"));
    }

    @Test
    void handleAbfrageStatusNotAllowedException() {
        final AbfrageStatusNotAllowedException abfrageStatusNotAllowedException = new AbfrageStatusNotAllowedException(
            "test"
        );
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("test")));
        assertThat(responseDto.getOriginalException(), is("AbfrageStatusNotAllowedException"));
    }
    ...
    void handleHttpRequestMethodNotSupported() {
        ...
        assertThat(responseDto.getTraceId(), is("1111111111111111"));
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Die HTTP-Methode test wird nicht unterstützt.")));
        assertThat(responseDto.getOriginalException(), is("HttpRequestMethodNotSupportedException"));
    }
    ...
    void handleHttpMediaTypeNotSupported() {
        ...
        assertThat(responseDto.getOriginalException(), is("HttpMediaTypeNotSupportedException"));
    }
    ...
    void handleHttpMediaTypeNotAcceptable() {
        ...
        assertThat(responseDto.getTraceId(), is("1111111111111111"));
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Der Media-Type des Requests wird nicht unterstützt.")));
        assertThat(responseDto.getOriginalException(), is("HttpMediaTypeNotAcceptableException"));
    }

    @Test
    void handleMissingPathVariable() {
        final MissingPathVariableException missingPathVariableException = new MissingPathVariableException(
            "nameOfVariable",
            null
        );
        ...
        assertThat(responseDto.getTraceId(), is("1111111111111111"));
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Der Pfadvariable nameOfVariable ist nicht gesetzt.")));
        assertThat(responseDto.getOriginalException(), is("MissingPathVariableException"));
    }
    ...
    void handleMissingServletRequestParameter() {
        ...
        assertThat(responseDto.getTraceId(), is("1111111111111111"));
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Der Requestparameter nameParameter ist nicht gesetzt.")));
        assertThat(responseDto.getOriginalException(), is("MissingServletRequestParameterException"));
    }

    @Test
    void handleServletRequestBindingException() {
        final ServletRequestBindingException servletRequestBindingException = new ServletRequestBindingException(
            "test"
        );
        ...
        assertThat(responseDto.getOriginalException(), is("ServletRequestBindingException"));
    }

    @Test
    void handleConversionNotSupported() {
        final ConversionNotSupportedException conversionNotSupportedException = new ConversionNotSupportedException(
            new Object(),
            null,
            null
        );
        ...
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Im Backend ist ein Fehler aufgetreten.")));
        assertThat(responseDto.getOriginalException(), is("ConversionNotSupportedException"));
    }
    ...
    void handleTypeMismatch() {
        ...
        assertThat(responseDto.getOriginalException(), is("TypeMismatchException"));
    }
    ...
    void handleHttpMessageNotWritable() {
        final HttpMessageNotWritableException httpMessageNotWritableException = new HttpMessageNotWritableException(
            "test"
        );
    ...
    void handleMethodArgumentNotValid() {
        ...
        assertThat(responseDto.getOriginalException(), is("MethodArgumentNotValidException"));
    }
    ...
    void handleNoHandlerFoundException() {
        ...
        assertThat(responseDto.getOriginalException(), is("NoHandlerFoundException"));
    }
    ...
    void handleAsyncRequestTimeoutException() {
        ...
        assertThat(responseDto.getTraceId(), is("1111111111111111"));
        assertThat(responseDto.getSpanId(), is("ffffffffffffffff"));
        assertThat(responseDto.getMessages(), is(List.of("Im Backend ist ein Timeout aufgetreten.")));
        assertThat(responseDto.getOriginalException(), is("AsyncRequestTimeoutException"));
    }
