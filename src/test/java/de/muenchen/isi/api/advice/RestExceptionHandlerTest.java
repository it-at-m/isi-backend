...
class RestExceptionHandlerTest {
    ...
    @Test
    void handleAutoGeneratedFieldSetException() {
        final AutoGeneratedFieldSetException exception = new AutoGeneratedFieldSetException(
            "Ein automatisch generiertes Feld wurde verbotener Weise gesetzt."
        );

        final ResponseEntity<Object> response = this.restExceptionHandler.handleAutoGeneratedFieldSetException(
            exception
        );
        ...
        assertThat(
            ...
            is(List.of("Ein automatisch generiertes Feld wurde verbotener Weise gesetzt."))
        );
        assertThat(responseDto.getOriginalException(), is("AutoGeneratedFieldSetException"));
    }
