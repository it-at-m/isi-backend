...
class InfrastruktureinrichtungListenerTest {

    @Autowired
    private InfrastruktureinrichtungListener infrastruktureinrichtungListener;

    @Test
    @MockCustomUser
    void beforeSave() {
        final var entityToSave = new Kinderkrippe();
        infrastruktureinrichtungListener.beforeSave(entityToSave);

        final var expected = new Kinderkrippe();
