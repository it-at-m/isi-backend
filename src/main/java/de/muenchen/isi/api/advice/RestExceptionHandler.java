...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AutoGeneratedFieldSetException.class)
    public ResponseEntity<Object> handleAutoGeneratedFieldSetException(final AutoGeneratedFieldSetException ex) {
        final var httpStatus = HttpStatus.BAD_REQUEST;
        final var errorResponseDto =
            this.createInformationResponseDtoWithTraceInformationAndTimestampAndOriginalExceptionNameAndStatusAndMessage(
                ex,
