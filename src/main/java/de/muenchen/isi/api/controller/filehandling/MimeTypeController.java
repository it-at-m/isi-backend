...
public class MimeTypeController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "406", description = "NOT ACCEPTABLE -> Die referenzierte und im S3-Storage befindliche Datei besitzt keine gültigen Mime-Type.", content = @Content(schema = @Schema(implementation = InformationResponseDto.class))),
    ...
    public ResponseEntity<MimeTypeInformationDto> extractMediaTypeInformationForAllowedMediaType(@RequestBody
                                                                                                 @NotNull
                                                                                                 @Valid final FilepathDto filepathDto) throws FileHandlingWithS3FailedException, FileHandlingFailedException, MimeTypeExtractionFailedException, MimeTypeNotAllowedException {
        final MimeTypeInformationModel model = this.mimeTypeService.extractMediaTypeInformationForAllowedMediaType(this.filehandlingApiMapper.dto2Model(filepathDto));
