...
public class KinderkrippeController {
    ...
    public ResponseEntity<List<KinderkrippeDto>> getKinderkrippen() {
        final List<KinderkrippeDto> kinderkrippeList =
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_READ_KINDERKRIPPE.name())")
    public ResponseEntity<KinderkrippeDto> getKinderkrippeById(@PathVariable @NotNull final UUID id)
    ...
    public ResponseEntity<KinderkrippeDto> createKinderkrippe(
        @RequestBody @Valid @NotNull final KinderkrippeDto kinderkrippeDto
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_WRITE_KINDERKRIPPE.name())")
    public ResponseEntity<KinderkrippeDto> updateKinderkrippe(
        @RequestBody @Valid @NotNull final KinderkrippeDto kinderkrippeDto
    ) throws EntityNotFoundException, OptimisticLockingException {
        var model = this.infrastruktureinrichtungApiMapper.dto2Model(kinderkrippeDto);
        final var infrastruktureinrichtung =
    ...
    public ResponseEntity<Void> deleteKinderkrippeById(@PathVariable @NotNull final UUID id)
