...
public class FoerdermixStammController {
    ...
    public ResponseEntity<FoerdermixStammDto> saveFoerdermixStamm(@RequestBody @Valid @NotNull final FoerdermixStammDto foerdermixStammDto) throws OptimisticLockingException {
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_WRITE_STAMMDATEN_FOERDERMIX.name())")
    public ResponseEntity<FoerdermixStammDto> updateFoerdermixStamm(@RequestBody @Valid @NotNull final FoerdermixStammDto foerdermixStammDto) throws EntityNotFoundException, OptimisticLockingException {
        var model = this.stammdatenApiMapper.dto2Model(foerdermixStammDto);
