...
public class FoerdermixStammController {
    ...
    public ResponseEntity<List<FoerdermixStammDto>> getFoerdermixStaemme() {
        final List<FoerdermixStammDto> foerdermixStammList = this.foerdermixStammService
    ...
    public ResponseEntity<FoerdermixStammDto> getFoerdermixStammById(@PathVariable @NotNull final UUID id)
    ...
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_DELETE_STAMMDATEN_FOERDERMIX.name())"
    )
    @Transactional
