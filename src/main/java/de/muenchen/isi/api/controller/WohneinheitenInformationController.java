...
public class WohneinheitenInformationController {
    ...
    public ResponseEntity<WohneinheitenInformationDto> calculateWohneinheitenInformation(
            @RequestBody @NotNull final AbfragevarianteResponseDto abfragevariante
    ) {
        final AbfragevarianteResponseModel abfragevarianteModel = this.abfragevarianteApiMapper.dto2Model(abfragevariante);
