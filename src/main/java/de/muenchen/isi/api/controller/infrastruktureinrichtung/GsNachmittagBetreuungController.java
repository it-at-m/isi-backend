...
public class GsNachmittagBetreuungController {
    ...
    public ResponseEntity<List<GsNachmittagBetreuungDto>> getGsNachmittagBetreuungen() {
        final List<GsNachmittagBetreuungDto> gsNachmittagBetreuungList =
    ...
    public ResponseEntity<GsNachmittagBetreuungDto> getGsNachmittagBetreuungById(@PathVariable @NotNull final UUID id)
    ...
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_WRITE_GS_NACHMITTAG_BETREUUNG.name())"
    )
    public ResponseEntity<GsNachmittagBetreuungDto> createGsNachmittagBetreuung(
        @RequestBody @Valid @NotNull final GsNachmittagBetreuungDto gsNachmittagBetreuungDto
    ...
    public ResponseEntity<GsNachmittagBetreuungDto> updateGsNachmittagBetreuung(
        @RequestBody @Valid @NotNull final GsNachmittagBetreuungDto gsNachmittagBetreuungDto
    ) throws EntityNotFoundException, OptimisticLockingException {
        var model = this.infrastruktureinrichtungApiMapper.dto2Model(gsNachmittagBetreuungDto);
        final var infrastruktureinrichtung =
    ...
    @Transactional
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_DELETE_GS_NACHMITTAG_BETREUUNG.name())"
    )
    public ResponseEntity<Void> deleteGsNachmittagBetreuungById(@PathVariable @NotNull final UUID id)
