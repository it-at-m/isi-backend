...
public class HausFuerKinderController {
    ...
    public ResponseEntity<List<HausFuerKinderDto>> getHaeuserFuerKinder() {
        final List<HausFuerKinderDto> hausFuerKinderList =
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_READ_HAUS_FUER_KINDER.name())")
    public ResponseEntity<HausFuerKinderDto> getHausFuerKinderById(@PathVariable @NotNull final UUID id)
    ...
    public ResponseEntity<HausFuerKinderDto> createHausFuerKinder(
        @RequestBody @Valid @NotNull final HausFuerKinderDto hausFuerKinderDto
    ...
    @PreAuthorize("hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_WRITE_HAUS_FUER_KINDER.name())")
    public ResponseEntity<HausFuerKinderDto> updateHausFuerKinder(
        @RequestBody @Valid @NotNull final HausFuerKinderDto hausFuerKinderDto
    ) throws EntityNotFoundException, OptimisticLockingException {
        var model = this.infrastruktureinrichtungApiMapper.dto2Model(hausFuerKinderDto);
        final var infrastruktureinrichtung =
    ...
    @Transactional
    @PreAuthorize(
        "hasAuthority(T(de.muenchen.isi.security.AuthoritiesEnum).ISI_BACKEND_DELETE_HAUS_FUER_KINDER.name())"
    )
    public ResponseEntity<Void> deleteHausFuerKinderById(@PathVariable @NotNull final UUID id)
