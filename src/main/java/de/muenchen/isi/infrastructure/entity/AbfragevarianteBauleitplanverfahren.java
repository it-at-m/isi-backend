...
public class AbfragevarianteBauleitplanverfahren extends Abfragevariante {
    ...
    @JoinColumn(name = "abfrgvar_bauleitplnvrfhrn_bauratendatei_basis_id", referencedColumnName = "id")
    private BauratendateiInput bauratendateiInputBasis;

    @OneToMany(cascade = { CascadeType.ALL }, orphanRemoval = true)
    @JoinColumn(name = "abfrgvar_bauleitplnvrfhrn_bauratendatei_id", referencedColumnName = "id")
