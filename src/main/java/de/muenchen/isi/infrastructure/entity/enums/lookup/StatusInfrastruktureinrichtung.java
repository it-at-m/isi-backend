...
public enum StatusInfrastruktureinrichtung implements ILookup {
    ...
    GESICHERTE_PLANUNG_NEUE_EINR("gesicherte Planung – neue Einrichtung", new String[] {
        "gesicherte",
        "Planung",
        "neue",
        "Einrichtung",
    ...
    GESICHERTE_PLANUNG_TF_KITA_STANDORT("gesicherte Planung – TF Kita Standort", new String[] {
        "gesicherte",
        "Planung",
        "TF",
        "Kita",
    ...
    GESICHERTE_PLANUNG_INTERIMSSTANDORT("gesicherte Planung – Interimsstandort", new String[] {
        "gesicherte",
        "Planung",
        "Interimsstandort",
    }),
    UNGESICHERTE_PLANUNG_TF_KITA_STANDORT("ungesicherte Planung – TF Kita Standort", new String[] {
        "ungesicherte",
        "Planung",
        "TF",
        "Kita",
