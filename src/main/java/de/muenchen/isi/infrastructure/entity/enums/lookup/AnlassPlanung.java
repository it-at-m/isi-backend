...
public enum AnlassPlanung implements ILookup {
    ...
    NEUE_EINRICHTUNG_PRIVATER_TRAEGER("Neue Einrichtung privater Träger", new String[] {
        "Neue",
        "Einrichtung",
        "privater",
        "Träger",
    }),
    REDUZIERUNG_PLAETZE_BEI_BESTANDSEINRICHTUNG("Reduzierung Plätze bei Bestandseinrichtung", new String[] {
        "Reduzierung",
        "Plätze",
        "bei",
        "Bestandseinrichtung",
    }),
    ERWEITERUNG_BESTEHENDER_EINRICHTUNG("Erweiterung bestehender Einrichtung", new String[] {
        "Erweiterung",
        "bestehender",
        "Einrichtung",
    }),
