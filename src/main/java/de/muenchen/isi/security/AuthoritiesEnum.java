...
public enum AuthoritiesEnum {
    ...
    ISI_BACKEND_POST_ABFRAGE_ABFRAGEERSTELLER,
    ISI_BACKEND_ISI_BACKEND_PATCH_ABFRAGE_ANGELEGT_ABFRAGEERSTELLER,
    ISI_BACKEND_PATCH_ABFRAGE_OFFEN_IN_BEARBEITUNG_PLAN_ABFRAGEBEARBEITER,
    ISI_BACKEND_PATCH_ABFRAGE_IN_BEARBEITUNG_FACHREFERATE_ABFRAGEBEARBEITER,
    ISI_BACKEND_PATCH_ABFRAGE_BEDARFSMELDUNG_ERFOLGT_ABFRAGEBEARBEITER,
