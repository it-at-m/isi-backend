...
public enum AuthoritiesEnum {
    ...
    ISI_BACKEND_PATCH_ABFRAGE_START_BEARBEITUNG,
    ISI_BACKEND_PATCH_ABFRAGE_EINPFLEGEN_BEDARFSMELDUNG,
    ISI_BACKEND_PATCH_ABFRAGE_EINPLANUNG_BEDARFE,
    ...
    ISI_BACKEND_WRITE_KOMMENTAR_BAUVORHABEN,
    ISI_BACKEND_WRITE_KOMMENTAR_INFRASTRUKTUREINRICHTUNG,
    ISI_BACKEND_DELETE_KOMMENTAR_BAUVORHABEN,
    ISI_BACKEND_DELETE_KOMMENTAR_INFRASTRUKTUREINRICHTUNG,
}
