...
public class WohneinheitenInformationService {
    ...
    public WohneinheitenInformationModel sum(
        ...
        final var realisierungsZeitraum = this.aggregate(o1.getRealisierungsZeitraum(), o2.getRealisierungsZeitraum());
    ...
    public RealisierungsZeitraumModel aggregate(
        ...
        final var von = ObjectUtils.min(o1.getRealisierungVon(), o2.getRealisierungVon());
        final var bis = ObjectUtils.max(o1.getRealisierungBis(), o2.getRealisierungBis());
