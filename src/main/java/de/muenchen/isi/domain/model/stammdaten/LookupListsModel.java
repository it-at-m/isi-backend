...
public class LookupListsModel {
    ...
    private LookupListModel wesentlicheRechtsgrundlageWeiteresVerfahren;

    private LookupListModel wesentlicheRechtsgrundlageBauvorhaben;
    ...
    private LookupListModel bauratenmethodik;
}
