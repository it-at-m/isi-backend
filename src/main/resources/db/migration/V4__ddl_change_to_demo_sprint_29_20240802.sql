...
ALTER TABLE IF EXISTS isidbuser.sobon_orientierungswert_soziale_infrastruktur
    ALTER COLUMN einwohner_jahr1nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr2nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr3nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr4nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr5nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr6nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr7nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr8nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr9nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN einwohner_jahr10nach_ersterstellung TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN stammwert_arbeitsgruppe TYPE numeric(20,15) SET NOT NULL,
    ALTER COLUMN gueltig_ab TYPE timestamp(6) without time zone SET NOT NULL;
